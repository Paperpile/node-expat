...
It contains prebuilt Electron binaries for Mac and Windows (created by [prebuildify](https://github.com/prebuild/prebuildify)). These are automatically picked up by `electron-builder`. Thanks to that, we can build for both platforms from a Mac.
